    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            for i, pi in enumerate(p):
                ...
                # BUGFIX FOR P6-MODELS https://stackoverflow.com/questions/74372636/indices-should-be-either-on-cpu-or-on-the-same-device-as-the-indexed-tensor
...
class ComputeLossAuxOTA:
    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            # BUGFIX FOR P6-MODELS: https://github.com/WongKinYiu/yolov7/issues/1101
            matching_matrix = torch.zeros_like(cost, device='cpu')
